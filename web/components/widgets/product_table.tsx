    ...
    return (
      <Card title="Rentabilidad por producto" subtitle={subtitle}>
        <EmptyState
          ...
          instruction="Cargue el catálogo con SKU y costo unitario, y verifique que las guías traigan el SKU del producto. Sin ese cruce Master Data no puede repartir el recaudo entre productos."
        />
      </Card>
    );
  }
