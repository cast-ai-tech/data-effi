    ...
    return (
      <Card title="Semáforo geográfico" subtitle={subtitle}>
        <EmptyState
          ...
          instruction={`Las guías cargadas no traen ${level1Label.toLowerCase()} ni ciudad de destino. Revise el mapeo de columnas de destino en la conexión de guías para que Master Data pueda ubicar cada despacho.`}
        />
      </Card>
    );
  }
