    ...
    return (
      <Card title="Del recaudo a la contribución">
        <EmptyState
          ...
          instruction="Conecta la plataforma de recaudo o sube el archivo de movimientos desde Cargas para descomponer el recaudo en producto, flete, comisiones y pauta."
        />
      </Card>
    );
  }
