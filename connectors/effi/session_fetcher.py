...
the browser, while logged in. That means Norte acts on the user's behalf with the
...
3. NO EVASION. Norte identifies itself in the User-Agent, obeys a minimum delay
...
USER_AGENT = "Norte-Analytics/1.0 (+operador autorizado por el comerciante)"
