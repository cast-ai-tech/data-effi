...
Lo que Master Data guarda es el **nombre** de una variable de entorno
...
Desactivar la conexión en Master Data detiene a Master Data. Para cortar el acceso de raíz,
