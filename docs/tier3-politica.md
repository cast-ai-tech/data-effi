...
> No es papeleo: define qué hace Data Effi con tus credenciales y qué riesgo asumes.

## Qué es un Tier

Data Effi clasifica cada fuente de datos por **cómo** obtiene la información:
...
| **3** | Data Effi entra con **tu sesión de usuario** y descarga el mismo reporte que descargarías tú a mano | Effi | **Alto — requiere tu consentimiento explícito** |
...
Data Effi puede pulsar ese botón por ti — pero solo si tú lo autorizas, y solo bajo las
reglas de abajo.
...
Lo que Data Effi guarda es el **nombre** de una variable de entorno
...
### 3. Data Effi se identifica y no evade nada
...
- **La sesión expira.** Tendrás que renovarla cada cierto tiempo. Data Effi te avisa,
  no lo hace solo.

## La alternativa siempre está disponible

Todo lo que hace el Tier 3 lo puedes hacer con **Tier 2**: exportas el reporte desde
el panel, lo subes a Data Effi, y obtienes exactamente los mismos dashboards. Es más
...
Desactivar la conexión en Data Effi detiene a Data Effi. Para cortar el acceso de raíz,
